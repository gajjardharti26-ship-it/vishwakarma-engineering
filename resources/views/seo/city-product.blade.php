        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <p class="lead text-secondary fs-6 mb-4">
                    Vishwakarma Engineering is a leading manufacturer, supplier, and exporter of high-precision <strong>{{ $productData['title'] }}</strong> serving chemical, pharmaceutical, bulk drug, and process manufacturing facilities across <strong>{{ $cityData['name'] }}</strong>{{ (strcasecmp($cityData['name'], $cityData['district']) !== 0 && !str_contains(strtolower($cityData['district']), strtolower($cityData['name']))) ? ' and ' . $cityData['district'] . ' district' : ' and surrounding Gujarat industrial estates' }}.
                </p>
            ...
            <div class="col-lg-8">
                ...
                <div class="bg-white p-4 p-md-5 rounded-4 shadow-sm mb-5">
                    <h2 class="h4 fw-bold text-dark mb-3">
                        Engineered for Industrial Facilities in {{ $cityData['name'] }}{{ (strcasecmp($cityData['name'], $cityData['district']) !== 0 && !str_contains(strtolower($cityData['district']), strtolower($cityData['name']))) ? ' & ' . $cityData['district'] . ' District' : ', Gujarat' }}
                    </h2>
